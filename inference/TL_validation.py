...
class TL_validation:
    ...
    def process_and_retrieve_similar_embeddings(self, topk):
         # Sample 100 random rows from the test data
        random_test_data = self.test_data.sample(n=100, random_state=42)
        accuracy_counter = 0;
        ...
        print("Accuracy: ", accuracy_counter/100)
...
if __name__ == "__main__":
    ...
    processor.process_and_retrieve_similar_embeddings(5)
